...
class InstanceManager:
    def __init__(self, url,ports, gpus, generate_model,startup_delay=30, api_key=None, extra_headers=None):
        self.ports = ports
        self.gpus = gpus
        self.base_url=url
        self.instances = []
        ...
        # 认证与请求头（支持在线DeepSeek等OpenAI兼容服务）
        ...
        self.request_headers = base_headers
