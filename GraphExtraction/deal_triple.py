...
import sys
sys.path.append("/newdataf/SJ/LeanRAG")
...
def truncate_data():
    ...
    relation_path="/newdataf/SJ/LeanRAG/GraphExtraction/ttt/relation.jsonl"
    relation_output_path="/newdataf/SJ/LeanRAG/GraphExtraction/ttt/relation_deal.jsonl"
    entity_path="/newdataf/SJ/LeanRAG/GraphExtraction/ttt/entity.jsonl"
    entity_output_path="/newdataf/SJ/LeanRAG/GraphExtraction/ttt/entity_deal.jsonl"
    res=[]
    i=0
